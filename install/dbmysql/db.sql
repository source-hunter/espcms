...
CREATE TABLE IF NOT EXISTS `esp_order` (
  ...
  `paysn` varchar(20) NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `esp_templates` (
  ...
  `styleclass` tinyint(1) unsigned NOT NULL default '1',
  `lockin` tinyint(1) unsigned NOT NULL default '1',
  `addtime` int(11) unsigned NOT NULL default '0',
  `isclass` tinyint(1) unsigned NOT NULL default '1',
  PRIMARY KEY  (`tmid`)
...
(8, 4, 'domain', '网站网址', '请填写当前网站域名，注意网址后加上“/”,如http://www.ecisp.cn/', '', 'string', '', 1, 0, ''),
...
(22, 1, 'upfile_dir', '上传文件夹', '请在字符最后加上“/”,例如：“upfile/”', 'upfile/', 'string', '', 9999, 0, ''),
(23, 5, 'upfile_maxsize', '文件大小限制', '不能超过服务器允许上传的最大设置，一般服务器不能超过2M', '2000000', 'selectkey', '200000|200K,500000|500K,1000000|1M,2000000|2M,3000000|3M,5000000|5M,10000000|10M,20000000|20M,30000000|30M,40000000|40M,50000000|50M,100000000|100M,150000000|150M,200000000|200M,250000000|250M', 4, 0, ''),
(24, 9, 'img_width', '图片宽', '单位：px', '200', 'int', '', 4, 0, ''),
(25, 10, 'img_height', '图片高', '单位：px', '200', 'int', '', 4, 0, ''),
(26, 11, 'img_bgcolor', '图片背景颜色', '请填写二进制颜色，白色：#ffffff 黑色：#000000 ', '#ffffff', 'font', '', 4, 0, ''),
...
(133, 4, 'is_inputclose', '继续发布控制', '如启用，则发布内容时不关闭当前窗口等待继续发布', '1', 'bool', '启用继续发布,禁用继续发布', 6, 0, ''),
...
(169, 50, 'sitecoedb', '远程通信密钥', '请设置不小于15位的远程通信密钥，用于站群管理', '', 'string', '', 1, 0, ''),
(170, 6, 'img_dirtype', '文件夹保存类型', '如您的图片较多，建议选择“按年/月/日保存”', 'y', 'selectkey', 'y|按年/月/日保存,m3|按年/月保存,d|按年/月日保存,m|按年月日保存,m1|按年月保存,m2|按年保存', 4, 0, ''),
...
(173, 2, 'mem_regisseccode', '会员注册验证码', '建议开启验证，以防止恶意注册', '1', 'bool', '开启会员注册验证码,禁用会员注册验证码', 2, 0, ''),
(174, 18, 'title_moblie', '', '手机短信发送接口（<a target="_blank" class="infolink06" href="http://www.ecisp.cn">点击在线申请短信接口</a>）', '', '', '', 6, 1, ''),
(175, 50, 'moblie_userid', '手机签约用户ID', '请填写您申请的接口用户名ID号', '0', 'font', '', 6, 0, ''),
(176, 50, 'moblie_smssnid', '短信接口ID', '请填写您申请的短信接口ID', '', 'font', '', 6, 0, ''),
(177, 50, 'moblie_smskey', '短信授权key码', '请填写短信接口key码', '', 'string', '', 6, 0, ''),
(178, 19, 'is_moblie', '开启短信发送', '如启用，请对以下短信发送接口参数进行设定', '0', 'bool', '启用短信发送,关闭短信发送', 6, 0, ''),
(179, 50, 'moblie_number', '短信手机号', '请填写您绑定的手机号码', '', 'font', '', 6, 0, ''),
(190, 50, 'softvol', '', '', '5900140828', 'string', '', 99, 0, ''),
(191, 50, 'softvolstr', '', '', 'V5.9.14.08.28 UTF8', 'strint', '', 99, 0, ''),
...
(77, 50, 'cn', '邮件发送失败', 'main_send_no', '抱歉：网站已禁用所选密码取回功能，相关功能无法使用，请与管理员系统！', 0, 1),
(78, 50, 'cn', '密码成功找回提示说明', 'password_lostok', '恭喜：新密码已成功发送到指定邮箱或手机，请查收并及时对随机密码进行更改！', 0, 1),
...
(801, 50, 'cn', '手机未绑定，相关功能操作失败', 'moblie_bangdinerr', '错误：因帐户手机未绑定，此功能操作失败！', 0, 1),
(802, 50, 'cn', '短信功能禁用', 'sms_send_no', '抱歉：手机短信功能已禁用，相关功能无法使用，请与管理员系统！', 0, 1),
(803, 50, 'cn', '绑定解除或修改', 'moblie_edit', '恭喜：您的手机绑定已经解除，请返回重新对手机进行绑定！', 0, 1),
(804, 50, 'cn', '手机绑定成功', 'moblie_ok', '恭喜：您的手机已绑定成功，如需修改请返回手机服务进行重新验证绑定！', 0, 1),
(846, 50, 'cn', '验证时间无效', 'moblie_timeerr', '错误：验证时间无效，请返回重新接收手机验证码！', 0, 1),
(847, 50, 'cn', '手机验证失败', 'moblie_validateerr', '抱歉：您的手机号码验证失败，请返回重新验证！', 0, 1),
(848, 50, 'cn', '手机号码格式错误或空', 'moblie_validate', '错误：您输入的手机号码为空或者格式不正确，请返回重新输入！', 0, 1),
(849, 50, 'en', '手机未绑定，相关功能操作失败', 'moblie_bangdinerr', 'Error: The mobile phone is not bound, this function operation failed!', 0, 1),
(850, 50, 'en', '短信功能禁用', 'sms_send_no', 'Error: mobile phone short message function is disabled, the relevant features are not available, please contact the system administrator!', 0, 1),
(851, 50, 'en', '绑定解除或修改', 'moblie_edit', 'Congratulations: mobile phone binding you has been lifted, please return to the mobile phone binding!', 0, 1),
(852, 50, 'en', '手机绑定成功', 'moblie_ok', 'Congratulations: your mobile phone has binding success, such as the need to modify the return to mobile phone service to verify the binding!', 0, 1),
(853, 50, 'en', '验证时间无效', 'moblie_timeerr', 'Error: invalid verification time, please return to receive mobile phone verification code!', 0, 1),
(854, 50, 'en', '手机验证失败', 'moblie_validateerr', 'Error: your mobile phone number validation failed, please return to verify!', 0, 1),
(855, 50, 'en', '手机号码格式错误或空', 'moblie_validate', 'Error: enter your mobile phone number is empty or not in the correct format, please return to input!', 0, 1);
...
(38, 1, 0, 8, '管理员帐户', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=mangerlist', 1, 'mangerlist', '', 0),
(39, 2, 0, 8, '权限组管理', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=grouplist', 1, 'grouplist', '', 0),
(40, 3, 0, 8, '数据库管理', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=sqllist', 1, 'sqllist', '', 0),
(41, 5, 0, 8, '多语言管理', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=languagelist', 1, 'languagelist', 'b15', 1),
(42, 6, 0, 8, '语言包管理', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=lanpacklist', 1, 'lanpacklist', '', 0),
...
(45, 7, 0, 8, '系统设置', 'index.php?archive=management&action=tab&out=tabeditor&loadfun=syssetting', 1, 'syssetting', '', 0),
(46, 50, 0, 9, '内容添加', '', 0, 'docadd', '', 0),
(47, 50, 0, 9, '内容修改', '', 0, 'docedit', '', 0),
(48, 50, 0, 9, '内容删除', '', 0, 'docdel', '', 0),
...
(73, 50, 0, 41, '多语言添加', '', 0, 'lngadd', '', 0),
(74, 50, 0, 41, '多语言修改', '', 0, 'lngedit', '', 0),
(75, 50, 0, 41, '多语言删除', '', 0, 'dellng', '', 0),
...
(190, 4, 0, 8, '站点集群管理', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=sitelist', 1, 'sitelist', '', 0),
(191, 50, 0, 190, '站点添加', '', 0, 'siteadd', '', 0),
(192, 50, 0, 190, '站点修改', '', 0, 'siteedit', '', 0),
(193, 50, 0, 190, '站点删除', '', 0, 'sitedel', '', 0),
(194, 50, 0, 6, '手机短信模板', 'index.php?archive=management&action=tab&out=tabeditor&loadfun=smstemplate', 1, 'smstemplate', '', 0),
(195, 50, 0, 194, '手机短信模板添加', '', 0, 'smstemplateadd', '', 0),
(196, 50, 0, 194, '手机短信删除', '', 0, 'smstemplatedel', '', 0),
(197, 50, 0, 194, '手机短信修改', '', 0, 'smstemplateedit', '', 0),
(198, 50, 0, 41, '邮件模板复制', '', 0, 'mailpackcopy', '', 0),
(199, 50, 0, 41, '短信模板复制', '', 0, 'smspackcopy', '', 0),
(200, 50, 0, 7, '手机短信群发', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=smssendlist', 1, 'smssendlist', '', 0),
(201, 50, 0, 200, '短信发送添加', '', 0, 'smssendadd', '', 0),
(202, 50, 0, 200, '短信发送删除', '', 0, 'smssenddel', '', 0),
(203, 50, 0, 200, '短信发送修改', '', 0, 'smssendedit', '', 0),
(204, 50, 0, 7, '手机号分组', 'index.php?archive=management&action=tab&out=tabcenter&loadfun=moblietypelist', 1, 'moblietypelist', '', 0),
(205, 50, 0, 204, '添加手机号分组', '', 0, 'moblietypeadd', '', 0),
(206, 50, 0, 204, '删除手机号分类', '', 0, 'moblietypedel', '', 0),
(207, 50, 0, 204, '导入手机号', '', 0, 'moblieadd', '', 0),
(208, 50, 0, 204, '修改手机号分组', '', 0, 'moblietypeedit', '', 0),
(209, 50, 0, 204, '手机号导出', '', 0, 'moblieout', '', 0),
(210, 50, 0, 200, '短信群发提交', '', 0, 'smssendaway', '', 0);
...
(43, 'cn', '会员手机验证', 'mobliecode', '', '请输入以下验证码：[%idcode%]', '', '', 4, 1, 1373039897),
(44, 'cn', '最新订单管理员通知', 'orderto', '', '您有新订单，订单号为：[%ordersn%]', '', '', 4, 1, 1373039943),
(45, 'cn', '订单支付管理员通知', 'orderpay', '', '订单已支付成功，请注意处理，订单号为：[%ordersn%]', '', '', 4, 1, 1373040004),
(46, 'cn', '客户询盘通知', 'enqueryto', '', '您有新的询价请求，请注意处理，询盘编号：[%enquirysn%]', '', '', 4, 1, 1373040044),
(47, 'cn', '订单已处理', 'orderre', '', '您的订单（[%ordersn%]）已发货，请注意查收！', '', '', 4, 1, 1373040150),
(48, 'cn', '订单已撤销', 'orderdel', '', '您的订单已撤销，订单号为：[%ordersn%]', '', '', 4, 1, 1373040179),
(49, 'cn', '会员密码修改提醒', 'memberedit', '', '会员登陆密码已修改，新密码为：[%password%]，请确定是否本人操作', '', '', 4, 1, 1373040248),
(50, 'cn', '会员密码找回', 'memberpass', '', '您的会员登陆密码已经重置，重置密码为：[%password%]', '', '', 4, 1, 1373040299),
(51, 'en', '会员手机验证', 'mobliecode', '', '请输入以下验证码：[%idcode%]', '', '', 4, 1, 1373039897),
(52, 'en', '最新订单管理员通知', 'orderto', '', '您有新订单，订单号为：[%ordersn%]', '', '', 4, 1, 1373039943),
(53, 'en', '订单支付管理员通知', 'orderpay', '', '订单已支付成功，请注意处理，订单号为：[%ordersn%]', '', '', 4, 1, 1373040004),
(54, 'en', '客户询盘通知', 'enqueryto', '', '您有新的询价请求，请注意处理，询盘编号：[%enquirysn%]', '', '', 4, 1, 1373040044),
(55, 'en', '订单已处理', 'orderre', '', '您的订单（[%ordersn%]）已发货，请注意查收！', '', '', 4, 1, 1373040150),
(56, 'en', '订单已撤销', 'orderdel', '', '您的订单已撤销，订单号为：[%ordersn%]', '', '', 4, 1, 1373040179),
(57, 'en', '会员密码修改提醒', 'memberedit', '', '会员登陆密码已修改，新密码为：[%password%]，请确定是否本人操作', '', '', 4, 1, 1373040248),
(58, 'en', '会员密码找回', 'memberpass', '', '您的会员登陆密码已经重置，重置密码为：[%password%]', '', '', 4, 1, 1373040299);
